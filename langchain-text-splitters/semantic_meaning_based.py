...
# Here will also need to import an embedding model to convert the text into embedding.
# These embeddings will then be used to compute similarity scores using different 'breakpoint_threshold_type'.
# breakpoint_threshold_type is different statictical methods to computer it's similarity scores - Standard Deviation, ercentile, inter-quartile range, gradient, etc.
# breakpoint_threshold_amount is to define similarity more for diving chunks. Higher value means less chunks, Lower value means more chunks
...
# Here we will create_documents() to create chunks
