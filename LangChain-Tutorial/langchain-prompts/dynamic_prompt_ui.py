...
'''
## Promptemplate can also be defined in the same code
## Creating Template which will be used for creating the prompt
...
# Creating the prompt using template and replacing the value as per user selection.
# Here also invoke function is called which is different from the model.invoke.
